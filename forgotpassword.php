...
if (isset($_POST['submit'])) {
    ...
    if ($row = mysqli_fetch_array($result)) {
        $result = mysqli_query($con, "UPDATE users SET password = '" . $password . "' where email = '" . $email . "'");
        $cpassword_error = "password changed successfully";
    } else { 
        $cpassword_error =  "incorrect Email and/or Date Of Birth";
    }
